...
{
    [TestClass]
    public class DifferentConfirmPassword_2_10_ : TestBase
    {
        [TestMethod, TestCategory("ResetPassword")]
        public void _2_10_ShorterConfirmPassword()
        {
            Pages.ResetPassword.GoTo();
            Pages.ResetPassword.resetPasswordFields("Tes34tete12", "Tes34te12");
